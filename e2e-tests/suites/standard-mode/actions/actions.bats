...
@test "should return 0 if the action in the plan doesn't match the action of the decorator" {
  # Given
...
@test "should return 1 if the action in the plan matches the action of the decorator" {
  # Given
  terraform apply -auto-approve > /dev/null

  # A second apply should trigger the recreation of the untagged resource.
  terraform plan -out test.tfplan > /dev/null
